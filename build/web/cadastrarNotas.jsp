           ...
           <form class="form-inline" role="form" action="AlterarNotas" method="post">
              ...
              <div class="control-group">
                ...
                <div class="control-group">
                    ...
                    <div class="controls">
                          <input type="number" required="required" step="0.01" min="0" max="10" name="nota1" placeholder="Nota 1...">
                ...
                <div class="control-group">
                    <div class="controls">
                      ...
                      <input class="btn btn-primary" type="submit" value="Cadastrar"onclick="return confirm('Cadastrar notas?')/>
                    </div>
                </div>
            </form>
                <div class="control-group">
