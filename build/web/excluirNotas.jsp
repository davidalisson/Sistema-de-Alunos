...
<html>
    ...
    <body >
        ...
        <!-- FormulÃ¡rio-->
       <div id="divForm">
           <form class="form-inline" role="form" action="ExcluirNotas" method="post">
              ...
              <div class="control-group">
                ...
                <div class="control-group">
                    <div class="controls">
                      <input class="btn btn-primary" type="submit" value="Excluir" onclick="return confirm('Excluir notas desse aluno?')/>
                    </div>
                </div>
            </form>
                <div class="control-group">
